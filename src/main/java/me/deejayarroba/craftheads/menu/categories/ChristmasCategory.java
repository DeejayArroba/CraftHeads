...
public class ChristmasCategory extends Category {
	...
	public void setup() {
		...
		add("Snowman (2)", "Madam_Red", Material.SNOW_BLOCK, (short) 0);
		add("Snowman (3)", "GLaDOS", Material.SNOW_BLOCK, (short) 0);
		...
		add("Present (6)", "SparkingYellow", Material.CHEST, (short) 0);
